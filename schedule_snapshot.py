...
CATALOG = {
    ...
    "com.jalal.money-radar-reminder": {
        "title": "Money Radar site — daily green-light nag",
        "what": "Daily 07:05 Telegram nudge to the 📡 alerts chat until Jalal green-lights or parks the Money Radar maintenance site (plan: Notion page 3cf24bb1172e814cb5bee0e0d0ccf2fa + ~/PycharmProjects/money-radar/PLAN.md). Runs 2026-09-02 → 2026-09-30 then unloads itself",
